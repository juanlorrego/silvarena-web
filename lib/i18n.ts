...
export const translations = {
  es: {
    ...
    propuesta: {
      ...
      p2: 'Cabañas de madera entre el bosque de montaña. Jardines que florecen todo el año. Jacuzzis exteriores con las montañas como único horizonte.',
      ...
      feature2Sub: 'Con vista directa a las montañas',
      feature3: 'Jardines en flor',
      feature3Sub: 'Todo el año,\nsin excepción',
    },
    cabanas: {
    ...
    ubicacion: {
      label:  'Ubicación',
      title: 'Cómo llegar.',
      subtitle: 'Corregimiento de San José, La Ceja, Antioquia, Colombia.',
      desde:  'A 70 minutos del Aeropuerto Internacional José María Córdova (Rionegro)',
      gps:    'Ingresa "Silvarena Glamping" en Google Maps, Waze o la aplicación de tu preferencia',
      cerca:  ['La Ceja (20 mins)', 'El Retiro (30 mins)', 'Rionegro (50 mins)', 'Medellín (1h 15 mins)'],
    },
    footer: {
      descripcion:  'Glamping de lujo en medio de la naturaleza del Oriente Antioqueño. Privacidad, confort y experiencias únicas para reconectar contigo y lo que importa.',
      ...
      contacto: {
        whatsapp:    'WhatsApp',
        email:       'hola@silvarena.co',
        telefono:    '+57 333 270 2366',
        ubicacion:   'La Ceja, Antioquia',
        atencion:    'Atención 24/7',
        atencionSub: 'Siempre disponibles para ti',
      },
      legal:    '© 2026 Silvarena. Todos los derechos reservados.',
      disenado: 'Diseñado con propósito y naturaleza',
    },
    galeria: {
      title: 'Galería',
    ...
    contacto: {
      ...
      formValidacion: 'Por favor ingresa al menos tu celular o correo electrónico.',
    },
    tra: {
  ...
  en: {
    ...
    propuesta: {
      ...
      p2: 'Wooden cabins nestled in mountain forest. Gardens that bloom year-round. Outdoor hot tubs with the mountains as the only horizon.',
    ...
    ubicacion: {
      ...
      subtitle: 'Corregimiento de San José, La Ceja, Antioquia, Colombia.',
      desde:  '70 minutes from José María Córdova International Airport (Rionegro)',
      gps:    'Search "Silvarena Glamping" on Google Maps, Waze or your preferred app',
      cerca:  ['La Ceja (20 mins)', 'El Retiro (30 mins)', 'Rionegro (50 mins)', 'Medellín (1h 15 mins)'],
    },
    footer: {
      descripcion:  'Luxury glamping in the Antioquian East. Privacy, nature and unique experiences to reconnect with what matters.',
      ...
      contacto: {
        ...
        telefono:    '+57 333 270 2366',
        ubicacion:   'La Ceja, Antioquia',
        atencion:    '24/7 Support',
        atencionSub: 'Always available for you',
      },
      legal:    '© 2026 Silvarena. All rights reserved.',
      disenado: 'Designed with purpose and nature',
    },
    galeria: {
      title: 'Gallery',
    ...
    contacto: {
      ...
      formNombre:    'Name',
      formCelular:   'Cell phone (Optional)',
      formEmail:     'Email (Optional)',
      formMensaje:   'Message',
      formEnviar:    'Send message',
      formValidacion: 'Please enter at least your phone number or email address.',
    },
    tra: {
